...
<head>
    ...
    <style>
      ...
      body{
        ...
        background-image: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)),url(../src-y-fotos/fondoIndex2.png);
      ...
      .nuevoUsuario-opcion-en-nav:hover{
...
<body>
    <nav class="conte_nav">
        ...
        <nav class="nav">
            ...
            <div class="opo" style="display: inline-block;"><a href="index.php?route=login">Log in</a></div>
        </nav>
    </nav>
    ...
    <form class="form" method="post" action="index.php?route=register" >
      ...
      <div class="input-container">
        <input type="text" id="" placeholder="Ingrese su nombre" name="nombre" required/>
        <input type="text" id="" placeholder="Ingrese su apellido" name="apellido" required/>
        <input type="email" id="" placeholder="Ingrese email" name="email" required/>
        <span> </span>
      </div>
